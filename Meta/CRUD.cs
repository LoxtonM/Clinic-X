...
namespace ClinicX.Meta
{
    ...
    {
        public Task<int> CallStoredProcedure(string sType, string sOperation, int int1, int int2, int int3, string string1, string string2, string string3, string text, string sLogin,
                       ...
                       //list of integers, strings, dates, and booleans that are passed to it.
    {
        ...
        public async Task<int> CallStoredProcedure(string sType, string sOperation, int int1, int int2, int int3, 
