...
builder.Services.AddScoped<IRelativeDiarySourceDataAsync, RelativeDiarySourceDataAsync>();
...
builder.Services.AddScoped<IDiaryClinicianDataAsync, DiaryClinicianDataAsync>();
